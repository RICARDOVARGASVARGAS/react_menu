        ...
        <main className="p-1">
          <div className="bg-gray-50 shadow-md rounded-lg p-4">
            ...
            <div className="flex overflow-auto justify-around mb-6 border-b w-full">
              <ProtectedComponent requiredPermissions={"driver.edit"}>
                <button
              ...
              <ProtectedComponent requiredPermissions={"driver.license"}>
                <button
                  className={`flex items-center gap-2 py-2 px-4 ${
                    activeTab === "license"
                      ? "text-blue-600 border-b-2 border-blue-600 font-bold"
              ...
              <ProtectedComponent requiredPermissions={"driver.car"}>
                <button
                  className={`flex items-center gap-2 py-2 px-4 ${
                    activeTab === "vehicles"
                      ? "text-blue-600 border-b-2 border-blue-600 font-bold"
