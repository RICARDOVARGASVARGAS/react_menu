  ...
  return (
    <>
      <div className="flex items-center justify-center my-3">
        {/* Front Side */}
        <div
          className="w-[8.56cm] h-[5.4cm] flex items-center justify-center p-0.5 bg"
          // style={{
          ...
          style={{
            // background:
            //   "linear-gradient(135deg, #d4b99e 33%, #a4def5 33%, #ffffff 66%, #b9ddb4 33%)",
          ...
          <div className="w-[8.56cm] h-[5.4cm] rounded-sm shadow-xl overflow-hidden relative">
            ...
            >
              ...
              <div className="space-y-0.5 relative z-10">
                <div className="p-0.5  shadow-md rounded-sm">
                  ...
                  <div className="mt-0.5 text-gray-800 font-bold text-[0.4rem] uppercase">
                    {carData?.group?.name || "N/A"}
                  </div>
                </div>
                <div className="p-0.5  shadow-md rounded-sm">
                  <label className="font-bold text-gray-600 text-[0.35rem]">
                ...
                <div className="p-0.5  shadow-md rounded-sm">
                  ...
                  <div className="mt-0.5 text-gray-800 font-bold text-[0.4rem]">
                    {formatDate(carData?.latest_permit?.issue_date)}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-0.5 relative z-10">
                <div className="p-0.5 shadow-md rounded-sm">
                  ...
                  <div className="mt-0.5 text-gray-800 font-bold text-[0.4rem] uppercase">
                    {(
                      (carData?.driver?.first_name || "") +
                      " " +
                      (carData?.driver?.last_name || "") +
                      " " +
                      (carData?.driver?.name || "")
                    )
                      .trim()
                      .substring(0, 22) +
                      (carData?.driver?.name?.length > 20 ? "..." : "")}
                  </div>
                </div>
                <div className="p-0.5  shadow-md rounded-sm">
                  <label className="font-bold text-gray-600 text-[0.35rem]">
                ...
                <div className="p-0.5  shadow-md rounded-sm">
                  ...
                  <div className="mt-0.5 text-gray-800 font-bold text-[0.4rem] uppercase flex items-center gap-1">
                ...
                <div className="p-0.5  shadow-md rounded-sm">
                  ...
                  <div className="mt-0.5 text-gray-800 font-bold text-[0.4rem]">
                    {formatDate(carData?.latest_permit?.expiration_date)}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-0.5 relative z-10">
                <div className="p-0.5  shadow-md rounded-sm">
                  ...
                  <div className="mt-0.5 text-gray-800 font-bold text-[0.4rem]">
                    {carData?.driver?.document_number || "N/A"}
                  </div>
                </div>
                <div className="p-0.5  shadow-md rounded-sm">
                  <label className="font-bold text-gray-600 text-[0.35rem]">
            ...
            <div className="px-1 py-0.5 h-4 flex justify-center items-center">
              <div className="flex justify-center items-center">
                <span className="font-bold text-gray-800 text-[0.4rem]">
                  RUTAS AUTORIZADAS:
                </span>
                <span className="ml-1 font-semibold text-gray-800 text-[0.4rem]">
