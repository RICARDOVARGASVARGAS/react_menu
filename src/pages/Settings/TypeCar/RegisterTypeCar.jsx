...
/**
 * Componente para agregar un nuevo Tipo de Vehículo
...
const RegisterTypeCar = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/registerTypeCar`, {
        method: "POST",
        headers: {
      ...
      console.log(error);
      toast.error("Error al registrar el Tipo de Vehículo.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="container mx-auto p-2 bg-white shadow-lg rounded-lg relative max-h-[80vh] overflow-y-auto">
      ...
      <h2 className="text-2xl font-bold mb-4">Registrar Tipo de Vehículo</h2>
